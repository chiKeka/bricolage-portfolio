...
- [**master**](02-Agents/master/IDENTITY.md): reads the goal, picks the domain, delegates
...
- [**assembler**](02-Agents/assembler/IDENTITY.md): takes the plan plus acquired access and builds the outcome
